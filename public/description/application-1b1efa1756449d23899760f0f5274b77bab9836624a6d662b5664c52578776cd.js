...
class ExpandButton {
  ...
  constructor(data) {
    ...
    this.$el = $(`<button class="my-1 btn btn-secondary btn-sm">${this.expandText}</button>`);
...
class ContextNavigation {
  ...
  getData() {
    ...
    // HT https://gitlab.oit.duke.edu/dul-its/dul-arclight/-/blob/develop/app/assets/javascripts/arclight/context_navigation.js
    var childrencount = parseInt(this.el.parent().data('childrencount'));
    if(childrencount > 100) {
      this.el.prepend('<div class="load-warning">\
        <strong> <i class="fa fa-clock-o" aria-hidden="true"></i> Loading ' +
