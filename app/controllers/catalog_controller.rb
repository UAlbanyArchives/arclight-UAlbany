...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'repository_sim', label: 'Collecting Area'
    config.add_facet_field 'has_online_content_ssim', label: 'Digital Selections', query: {
    ...
    config.add_in_person_field 'repository_ssm', if: :repository_config_present, label: 'Collecting Area', helper_method: :context_sidebar_repository
