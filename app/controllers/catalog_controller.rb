...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_background_field 'odd_ssm', label: 'Other', helper_method: :render_html_tags
    ...
    config.add_in_person_field 'id', if: :before_you_visit_note_present, label: 'Access', helper_method: :context_access_tab_visit_note # Using ID because we know it will always exist
